...
// SetNullPrice provides a mock function with given fields: token
func (_m *MockStorage) SetNullPrice(token string) (int64, error) {
	ret := _m.Called(token)

	if len(ret) == 0 {
		panic("no return value specified for SetNullPrice")
	}
